...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__logout__ = __webpack_require__(1147);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_network__ = __webpack_require__(219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_navigation_navigation__ = __webpack_require__(542);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
var LogoutPage = /** @class */ (function (_super) {
    ...
    function LogoutPage(auth, loading, network, platform) {
        var _this = _super.call(this, { platform: platform }) || this;
        _this.auth = auth;
        _this.loading = loading;
        _this.network = network;
        _this.platform = platform;
        _this.disableBtnLogout = false;
        return _this;
    }
    ...
    LogoutPage.prototype.btnLogout = function () {
    ...
    LogoutPage.prototype.btnExit = function () {
        this.exitApp();
    };
    LogoutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-logout',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\settings\logout\logout.html"*/'<ion-content>\n\n    <ion-card full>\n\n        <ion-card-header text-wrap>\n\n            <strong>{{\'PAGE.LOGOUT.Header\' | translate}}?</strong>\n\n        </ion-card-header>\n\n\n\n        <ion-card-content>\n\n            <p ion-text color="danger" *ngIf="disableBtnLogout">\n\n                {{\'InternetRequired\' | translate}}.\n\n            </p>\n\n            <button ion-button text-wrap text-left clear small color="danger" no-padding no-margin icon-left (tap)="btnExit()" *ngIf="!disableBtnLogout">\n\n                <ion-icon name="exit"></ion-icon> {{\'PAGE.LOGOUT.RestartApp\' | translate}}\n\n            </button>\n\n        </ion-card-content>\n\n    </ion-card>\n\n\n\n    <ion-grid>\n\n        <ion-row>\n\n            <ion-col col-12 text-center>\n\n                <ion-icon large name="person"></ion-icon>\n\n                <p>\n\n                    {{\'PAGE.SETTINGS.LoggedInAs\' | translate}}\n\n                    <strong ion-text color="primary">{{auth.username}}</strong>.\n\n                </p>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-content>\n\n\n\n<ion-footer>\n\n    <ion-grid no-padding>\n\n        <ion-row>\n\n            <ion-col col-12 no-padding>\n\n                <button ion-button full large color="primary" no-margin [disabled]="disableBtnLogout" (tap)="btnLogout()">\n\n                    <div>\n\n                        <ion-icon name="log-out"></ion-icon>\n\n                        {{\'PAGE.LOGOUT.BtnConfirm\' | translate}}\n\n                    </div>\n\n                </button>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-footer>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\settings\logout\logout.html"*/,
        }),
