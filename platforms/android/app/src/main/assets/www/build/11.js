...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__item_details__ = __webpack_require__(1141);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_driver_rest_driver_rest__ = __webpack_require__(112);
...
var ItemDetailsPage = /** @class */ (function () {
    function ItemDetailsPage(itemApi, navParams, notify, viewCtrl) {
        this.itemApi = itemApi;
        this.navParams = navParams;
        this.notify = notify;
        this.viewCtrl = viewCtrl;
    }
    ItemDetailsPage.prototype.ionViewCanEnter = function () {
        var _this = this;
        var deliveryItem = this.navParams.get('deliveryItem');
        ...
        return this.itemApi.get(deliveryItem.ItemId)
            ...
            .catch(function (err) {
            _this.notify.error('Unable to get item details.', err);
            throw err;
        });
    };
    ItemDetailsPage.prototype.btnClose = function () {
        this.viewCtrl.dismiss();
    };
    ItemDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-item-details',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\item-details\item-details.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title>{{\'PAGE.ITEM_DETAILS.Header\' | translate}}</ion-title>\n\n        <ion-buttons end>\n\n            <button ion-button (click)="btnClose()">{{\'BUTTON.Close\' | translate}}</button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-list>\n\n        <ion-item-group>\n\n            <ion-list-header>\n\n                {{\'ITEM.Id\' | translate}}\n\n            </ion-list-header>\n\n            <ion-item text-wrap>\n\n                <ion-icon name="arrow-round-forward" item-start></ion-icon>\n\n                {{item.Id}}\n\n            </ion-item>\n\n        </ion-item-group>\n\n\n\n        <ion-item-group>\n\n            <ion-list-header>\n\n                {{\'ITEM.Weight\' | translate}}\n\n            </ion-list-header>\n\n            <ion-item text-wrap>\n\n                <ion-icon name="pricetag" item-start></ion-icon>\n\n                {{item.Weight}}\n\n            </ion-item>\n\n        </ion-item-group>\n\n\n\n        <ion-item-group>\n\n            <ion-list-header>\n\n                {{\'ITEM.Description\' | translate}}\n\n            </ion-list-header>\n\n            <ion-item text-wrap>\n\n                <ion-icon name="paper" item-start></ion-icon>\n\n                {{item.Description}}\n\n            </ion-item>\n\n        </ion-item-group>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\item-details\item-details.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_driver_rest_driver_rest__["b" /* ItemApi */],
