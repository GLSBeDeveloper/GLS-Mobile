...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__verify_code__ = __webpack_require__(1137);
    ...
    VerifyCodePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__verify_code__["a" /* VerifyCodePage */]),
            ],
        })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_current_job_current_job__ = __webpack_require__(854);
...
var VerifyCodePage = /** @class */ (function (_super) {
    ...
    function VerifyCodePage(currentJob, navCtrl, notify) {
        var _this = _super.call(this, { navCtrl: navCtrl }) || this;
    ...
    VerifyCodePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-verify-code',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\current-job\pod\verify-code\verify-code.html"*/'<ion-content>\n\n    <span *ngIf="!currentJob.verified">\n\n        <ion-card full color="dark">\n\n            <ion-card-content>\n\n                <ion-icon item-start name="alert"></ion-icon> {{\'PAGE.VERIFY_CODE.Prompt\' | translate}}.\n\n            </ion-card-content>\n\n        </ion-card>\n\n\n\n        <ion-item no-lines>\n\n            <ion-label color="primary" stacked>{{\'PAGE.VERIFY_CODE.AskToEnter\' | translate}}</ion-label>\n\n            <ion-input type="text" clearInput placeholder="{{\'JOB.VerificationCode\' | translate}}" [(ngModel)]="code"></ion-input>\n\n        </ion-item>\n\n    </span>\n\n\n\n    <ion-card full *ngIf="currentJob.verified">\n\n        <ion-card-header text-wrap color="secondary">\n\n            <ion-icon item-start name="checkmark-circle"></ion-icon> {{\'PAGE.VERIFY_CODE.Verified\' | translate}}\n\n        </ion-card-header>\n\n\n\n        <ion-card-content>\n\n            <p>\n\n                {{\'PAGE.VERIFY_CODE.HowToNavigate\' | translate}}\n\n            </p>\n\n            <p>\n\n                <span ion-text color="secondary">\n\n                    <ion-icon name="return-right"></ion-icon> {{\'PAGE.VERIFY_CODE.BtnPressProceed\' | translate}}.\n\n                </span>\n\n            </p>\n\n        </ion-card-content>\n\n    </ion-card>\n\n</ion-content>\n\n\n\n<ion-footer class="hide-on-keyboard-open">\n\n    <ion-grid no-padding>\n\n        <ion-row>\n\n            <ion-col col-12 no-padding>\n\n                <button ion-button full large color="secondary" no-margin (tap)="btnConfirm()">\n\n                    <div>\n\n                        <ion-icon name="return-right"></ion-icon>\n\n                        {{\'BUTTON.Proceed\' | translate}}\n\n                    </div>\n\n                </button>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-footer>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\current-job\pod\verify-code\verify-code.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_current_job_current_job__["a" /* CurrentJobProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
