...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_note__ = __webpack_require__(1129);
    ...
    AddNotePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__add_note__["a" /* AddNotePage */]),
            ],
        })
    ], AddNotePageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_camera_camera__ = __webpack_require__(855);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_navigation_navigation__ = __webpack_require__(542);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
var AddNotePage = /** @class */ (function (_super) {
    __extends(AddNotePage, _super);
    function AddNotePage(alertCtrl, camera, currentJob, navCtrl, notify, platform) {
        ...
        _this.maxNumNotePhotos = __WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].setting.note.maxNumPhoto;
        _this.optionRequired = __WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].setting.note.optionRequired;
        _this.optionList = __WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].setting.note.options;
        return _this;
    }
    AddNotePage.prototype.ionViewCanEnter = function () {
        var _this = this;
    ...
    AddNotePage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    AddNotePage.prototype.ionViewDidLeave = function () {
        if (this.btnBackEvent) {
            this.btnBackEvent();
        }
    };
    AddNotePage.prototype.btnConfirm = function () {
        this.currentJob.noteOption = Object(__WEBPACK_IMPORTED_MODULE_3_lodash_es__["l" /* trim */])(this.currentJob.noteOption);
        this.currentJob.noteText = Object(__WEBPACK_IMPORTED_MODULE_3_lodash_es__["l" /* trim */])(this.currentJob.noteText);
    ...
    AddNotePage.prototype.btnAddPhoto = function () {
        var _this = this;
