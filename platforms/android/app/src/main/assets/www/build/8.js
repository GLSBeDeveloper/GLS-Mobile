...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__login__ = __webpack_require__(1144);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_auth__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_diagnostic_diagnostic__ = __webpack_require__(545);
...
var LoginPage = /** @class */ (function (_super) {
    ...
    function LoginPage(auth, diagnostic, loading, modalCtrl, navCtrl, notify) {
        var _this = _super.call(this, { navCtrl: navCtrl }) || this;
        _this.auth = auth;
        ...
        _this.enableChangeUrl = __WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].features.showChangeUrl;
        _this.username = __WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].user.username;
        _this.showPassword = false;
        return _this;
    }
    LoginPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.diagnostic.isAppUpdated().then(function (isUpdated) {
            if (isUpdated === false) {
                var modal = _this.modalCtrl.create('CheckAppVersionPage', {}, { enableBackdropDismiss: false });
                return modal.present();
            }
        }).then(function () {
            var modal = _this.modalCtrl.create('LicenceAgreementPage', {}, { enableBackdropDismiss: false });
            modal.present();
        });
    };
    LoginPage.prototype.btnTogglePasswordView = function () {
        this.showPassword = !this.showPassword;
    };
    LoginPage.prototype.btnChangeUrl = function () {
    ...
    LoginPage.prototype.btnLogIn = function () {
        ...
        var loader = this.loading.show('Logging in');
        this.auth.login(this.username, this.password).then(function () {
            loader.dismiss();
            var modal = _this.modalCtrl.create('ChangeDriverDetailsPage', { isModal: true }, { enableBackdropDismiss: false });
            modal.onDidDismiss(function () { return _this.goHomePage(); });
            modal.present();
        }).catch(function (err) {
            loader.dismiss();
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-login',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\login\login.html"*/'<ion-content padding>\n\n    <ion-grid>\n\n        <ion-row padding-top>\n\n            <ion-col text-center>\n\n                <img [src]="img.path" [attr.height]="img.height">\n\n            </ion-col>\n\n        </ion-row>\n\n\n\n        <ion-row>\n\n            <ion-col>\n\n                <ion-list inset>\n\n                    <ion-item>\n\n                        <ion-label stacked>{{\'PAGE.LOGIN.Username\' | translate}}</ion-label>\n\n                        <ion-input type="text" placeholder="{{\'PAGE.LOGIN.Username\' | translate}}" [(ngModel)]="username" autocomplete="off" autocorrect="off" autocapitalize="off" clearInput></ion-input>\n\n                    </ion-item>\n\n\n\n                    <ion-item>\n\n                        <ion-label stacked>{{\'PAGE.LOGIN.Password\' | translate}}</ion-label>\n\n                        <ion-input [type]="showPassword ? \'text\' : \'password\'" placeholder="{{\'PAGE.LOGIN.Password\' | translate}}" [(ngModel)]="password" autocomplete="off" autocorrect="off" autocapitalize="off" clearOnEdit=false clearInput></ion-input>\n\n                        <ion-icon [name]="showPassword ? \'eye-off\' : \'eye\'" item-right tappable (tap)="btnTogglePasswordView()"></ion-icon>\n\n                    </ion-item>\n\n                </ion-list>\n\n            </ion-col>\n\n        </ion-row>\n\n\n\n        <ion-row>\n\n            <ion-col>\n\n                <button ion-button full round large-padding icon-right (tap)="btnLogIn()">\n\n                    {{\'PAGE.LOGIN.BtnLogIn\' | translate}}\n\n                    <ion-icon name="log-in"></ion-icon>\n\n                </button>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n\n\n    <ion-fab top right *ngIf="enableChangeUrl">\n\n        <button ion-fab mini color="orange" (tap)="btnChangeUrl()">\n\n            <ion-icon name="qr-scanner"></ion-icon>\n\n        </button>\n\n    </ion-fab>\n\n</ion-content>\n\n\n\n<ion-footer class="hide-on-keyboard-open" text-center padding no-border>\n\n    {{\'PAGE.LOGIN.PoweredBy\' | translate}}\n\n    <img src="/android_asset/www/assets/images/logo_simtech.png">\n\n    <img src="/android_asset/www/assets/images/logo_mct.png">\n\n</ion-footer>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\login\login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__providers_user_auth__["a" /* AuthProvider */],
            __WEBPACK_IMPORTED_MODULE_4__providers_diagnostic_diagnostic__["a" /* DiagnosticProvider */],
