...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_keyboard__ = __webpack_require__(850);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_status_bar__ = __webpack_require__(851);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_splash_screen__ = __webpack_require__(852);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_network__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_distinctUntilChanged__ = __webpack_require__(856);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_driver_rest_native_http__ = __webpack_require__(520);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_navigation_navigation__ = __webpack_require__(542);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
var MyApp = /** @class */ (function (_super) {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\app\app.html"*/'<ion-menu [id]="allJobsMenuId" side="right" persistent="true" [content]="content">\n\n\n\n    <ion-header>\n\n        <ion-toolbar>\n\n            <ion-title>Menu</ion-title>\n\n            <ion-buttons right>\n\n                <button ion-button [menuClose]="allJobsMenuId" clear>\n\n                    <ion-icon name="close"></ion-icon>\n\n                </button>\n\n            </ion-buttons>\n\n        </ion-toolbar>\n\n    </ion-header>\n\n\n\n    <ion-content>\n\n        <ion-list>\n\n            <button ion-item detail-none *ngFor="let page of allJobsMenuPages" (tap)="btnOpenPage(page)">\n\n                <ion-icon item-left [name]="page.icon"></ion-icon>\n\n                {{page.title}}\n\n            </button>\n\n        </ion-list>\n\n    </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<ion-nav #content></ion-nav>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\app\app.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__native_http__ = __webpack_require__(520);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__classes_job__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__classes_item__ = __webpack_require__(1064);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__user_auth_response__ = __webpack_require__(1065);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
var AuthApi = /** @class */ (function () {
    ...
    AuthApi.prototype.resetPassword = function (data) {
        if (data === void 0) { data = {}; }
        return this.http.put('api/auth/v2/password', data)
            .catch(CustomErrorHandler.catch);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__geolocation_geolocation__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__loading_loading__ = __webpack_require__(543);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__websocket_websocket__ = __webpack_require__(519);
...
var UserDriverProvider = /** @class */ (function () {
    ...
    UserDriverProvider.prototype.initDriver = function (userDetails) {
        ...
        this.overwriteGlobals(userDetails);
        ...
        return this.getJobsFromServer().then(function () {
            return _this.uploadOfflineJobs().catch(function () { });
        });
    };
    /**
     ...
     */
    UserDriverProvider.prototype.overwriteGlobals = function (serverSettings) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sql_table__ = __webpack_require__(1062);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__ = __webpack_require__(805);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_es__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__globals__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__driver_rest_driver_rest__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__notification_notification__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__user_user_driver__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__storage_storage__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_websocket_websocket__ = __webpack_require__(519);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
var AuthProvider = /** @class */ (function () {
    function AuthProvider(authApi, driver, notify, storage, websocket) {
         ...
         */
        this.notifier = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["BehaviorSubject"](undefined);
        this.forceChangePassword = false;
    }
    /**
     * Logs into server
    ...
    AuthProvider.prototype.login = function (username, password) {
        ...
        return this.authApi.login({ username: username, password: password })
            .then(function (userDetails) { return _this.initUser(userDetails); })
            .catch(function (err) {
    ...
    /**
     * Initialise user variables, regardless of role
     *
     * @private
     * @param {AuthResponse} userDetails  User object from server
     */
    AuthProvider.prototype.initUser = function (userDetails) {
        __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.token = userDetails.token;
        this.storage.setKeyValue(__WEBPACK_IMPORTED_MODULE_4__globals__["d" /* StorageKey */].ApiToken, __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.token);
        __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.username = userDetails.username;
        this.username = __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.username;
        this.storage.setKeyValue(__WEBPACK_IMPORTED_MODULE_4__globals__["d" /* StorageKey */].Username, __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.username);
        this.forceChangePassword = userDetails.forceChangePassword;
        this.synchroniseDate(userDetails.serverDate);
        this.initWebsocketEvents();
        this.driver.initDriver(userDetails);
    ...
    AuthProvider.prototype.resetUser = function () {
        __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.token = '';
        __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.previousJobsInfo = '';
        __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.vehicleId = '';
        __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.vehiclePlateNumber = '';
        __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].user.vehicleUserGroup = '';
        this.storage.setKeyValue(__WEBPACK_IMPORTED_MODULE_4__globals__["d" /* StorageKey */].ApiToken, '');
        this.storage.setKeyValue(__WEBPACK_IMPORTED_MODULE_4__globals__["d" /* StorageKey */].PreviousJobsInfo, '');
    ...
    AuthProvider.prototype.synchroniseDate = function (serverTime) {
        serverTime = Object(__WEBPACK_IMPORTED_MODULE_2_lodash_es__["l" /* trim */])(serverTime);
        if (serverTime) {
            var offset_1 = new Date(serverTime).getTime() - Date.now();
            __WEBPACK_IMPORTED_MODULE_3_moment__["now"] = function () {
    ...
    AuthProvider.prototype.initWebsocketEvents = function () {
        ...
        this.websocket.onJSON(__WEBPACK_IMPORTED_MODULE_9__providers_websocket_websocket__["a" /* WebsocketEvent */].Logout, function () {
    ...
    AuthProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__driver_rest_driver_rest__["a" /* AuthApi */],
            __WEBPACK_IMPORTED_MODULE_7__user_user_driver__["a" /* UserDriverProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_9__providers_websocket_websocket__["b" /* WebsocketProvider */]])
    ], AuthProvider);
    return AuthProvider;
}());
...
var GeolocationProvider = /** @class */ (function () {
    function GeolocationProvider(platform) {
        ...
        this.geolocationOptions = {
            ...
            reset: true,
            // turn off Log LOG_LEVEL_OFF, set to LOG_LEVEL_VERBOSE to record log, it is used with maxDaysToPersist
            ...
            stopTimeout: 5,
            // Application config
            // set to false, device will still tracking location when user force terminate app by swipe off in iOS platform.
            stopOnTerminate: false,
            // set to true, device will tracking location if user force re-start device.
            startOnBoot: true,
            // iOS
     ...
     * @param {string} vehiclePlateNumber  Platenumber of the vehicle that is assigned to driver
     */
    ...
    GeolocationProvider.prototype.getCurrentLocation = function () {
        if (this.bgGeo !== undefined) { // for web usage
            ...
            return this.bgGeo.getCurrentPosition({ samples: 1 }).then(function (response) { return ({
                coords: {
...
var Globals = /** @class */ (function () {
    ...
    Globals.defaultUrl = 'http://localhost';
    ...
    Globals.login = {
        page: 'LoginPage',
        image: {
            path: '/android_asset/www/assets/images/logo_company.png',
            height: '70px',
        },
    };
    Globals.home = {
        page: 'HomePage',
        title: 'SIMTech MCT <sup>TM</sup>',
    };
    Globals.features = {
        forceAppUpdate: true,
        /**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client_dist_socket_io__ = __webpack_require__(1063);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_network__ = __webpack_require__(219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__navigation_navigation__ = __webpack_require__(542);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_BehaviorSubject__ = __webpack_require__(805);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_BehaviorSubject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_BehaviorSubject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_es__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_app_version__ = __webpack_require__(806);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_diagnostic__ = __webpack_require__(807);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_base64__ = __webpack_require__(810);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_es__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__diagnostic_diagnostic__ = __webpack_require__(545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__geolocation_geolocation__ = __webpack_require__(218);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_camera__ = __webpack_require__(808);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_barcode_scanner__ = __webpack_require__(809);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser_dynamic__ = __webpack_require__(859);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_module__ = __webpack_require__(875);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__(558);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(544);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ngx_translate_http_loader__ = __webpack_require__(888);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_app_version__ = __webpack_require__(806);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_camera__ = __webpack_require__(808);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_barcode_scanner__ = __webpack_require__(809);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_base64__ = __webpack_require__(810);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_diagnostic__ = __webpack_require__(807);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_http__ = __webpack_require__(804);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_keyboard__ = __webpack_require__(850);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_launch_navigator__ = __webpack_require__(857);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_local_notifications__ = __webpack_require__(801);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_native_network__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ionic_native_photo_viewer__ = __webpack_require__(853);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_sqlite__ = __webpack_require__(803);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__ionic_native_status_bar__ = __webpack_require__(851);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ionic_native_splash_screen__ = __webpack_require__(852);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__app_component__ = __webpack_require__(1085);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__providers_user_auth__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__providers_driver_rest_native_http__ = __webpack_require__(520);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__providers_driver_rest_driver_rest__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__providers_camera_camera__ = __webpack_require__(855);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__providers_current_job_current_job__ = __webpack_require__(854);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__providers_diagnostic_diagnostic__ = __webpack_require__(545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__providers_geolocation_geolocation__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__providers_loading_loading__ = __webpack_require__(543);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__providers_notification_notification__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__providers_storage_storage__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__providers_user_user_driver__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__providers_websocket_websocket__ = __webpack_require__(519);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [
                ...
                // utils
                __WEBPACK_IMPORTED_MODULE_24__providers_camera_camera__["a" /* CameraProvider */],
                __WEBPACK_IMPORTED_MODULE_26__providers_diagnostic_diagnostic__["a" /* DiagnosticProvider */],
                __WEBPACK_IMPORTED_MODULE_27__providers_geolocation_geolocation__["a" /* GeolocationProvider */],
                __WEBPACK_IMPORTED_MODULE_28__providers_loading_loading__["a" /* LoadingProvider */],
                __WEBPACK_IMPORTED_MODULE_29__providers_notification_notification__["a" /* NotificationProvider */],
                __WEBPACK_IMPORTED_MODULE_30__providers_storage_storage__["a" /* StorageProvider */],
                // http api requests
                __WEBPACK_IMPORTED_MODULE_22__providers_driver_rest_native_http__["a" /* NativeHTTP */],
                __WEBPACK_IMPORTED_MODULE_23__providers_driver_rest_driver_rest__["a" /* AuthApi */],
                __WEBPACK_IMPORTED_MODULE_23__providers_driver_rest_driver_rest__["b" /* ItemApi */],
                __WEBPACK_IMPORTED_MODULE_23__providers_driver_rest_driver_rest__["c" /* JobsApi */],
                __WEBPACK_IMPORTED_MODULE_23__providers_driver_rest_driver_rest__["d" /* MailApi */],
                __WEBPACK_IMPORTED_MODULE_23__providers_driver_rest_driver_rest__["e" /* MiscApi */],
                __WEBPACK_IMPORTED_MODULE_23__providers_driver_rest_driver_rest__["f" /* VehicleApi */],
                // data service
                __WEBPACK_IMPORTED_MODULE_21__providers_user_auth__["a" /* AuthProvider */],
                __WEBPACK_IMPORTED_MODULE_25__providers_current_job_current_job__["a" /* CurrentJobProvider */],
                __WEBPACK_IMPORTED_MODULE_31__providers_user_user_driver__["a" /* UserDriverProvider */],
                // native plugins
                ...
                __WEBPACK_IMPORTED_MODULE_32__providers_websocket_websocket__["b" /* WebsocketProvider */],
            ],
        })
    ], AppModule);
    return AppModule;
