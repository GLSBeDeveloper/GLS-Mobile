...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home__ = __webpack_require__(1140);
...
var HomePage = /** @class */ (function (_super) {
    ...
    function HomePage(alertCtrl, auth, diagnostic, driver, modalCtrl, navCtrl, platform) {
        ...
        _this.headerText = __WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].home.title;
        return _this;
    }
    ...
    HomePage.prototype.ionViewDidEnter = function () {
        if (this.auth.forceChangePassword) {
            var modal = this.modalCtrl.create('ResetPasswordPage', { isModal: true }, { enableBackdropDismiss: false });
    ...
    HomePage.prototype.btnDoJob = function () {
        if (this.driver.currentJob !== undefined) {
            this.goPage('CurrentJobPage', { job: this.driver.currentJob });
        }
    };
    HomePage.prototype.btnAllJobs = function () {
        this.goPage('AllJobsPage');
    };
    HomePage.prototype.btnSettings = function () {
        this.goPage('SettingPage');
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-home',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\home\home.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <vrp-header>\n\n            <div [innerHTML]="headerText"></div>\n\n        </vrp-header>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-grid no-padding no-margin>\n\n        <ion-row>\n\n            <ion-col>\n\n                <vrp-progress-bar [jobs]="driver.jobs"></vrp-progress-bar>\n\n            </ion-col>\n\n        </ion-row>\n\n\n\n        <ion-row>\n\n            <ion-col tappable (tap)="btnDoJob()">\n\n                <vrp-job-details [job]="driver.currentJob" *ngIf="driver.currentJob"></vrp-job-details>\n\n\n\n                <ion-list *ngIf="!driver.currentJob">\n\n                    <ion-list-header color="dark">\n\n                        {{\'Done\' | translate}}!\n\n                    </ion-list-header>\n\n\n\n                    <ion-item text-wrap>\n\n                        <ion-icon name="thumbs-up" item-start></ion-icon>\n\n                        {{\'PAGE.HOME.AllDone\' | translate}}!\n\n                    </ion-item>\n\n                </ion-list>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-content>\n\n\n\n<ion-footer>\n\n    <ion-grid no-padding>\n\n        <ion-row>\n\n            <ion-col col-6 no-padding>\n\n                <button ion-button full large color="green" no-margin (tap)="btnSettings()">\n\n                    <div>\n\n                        <ion-icon name="settings"></ion-icon>\n\n                        {{\'BUTTON.Settings\' | translate}}\n\n                    </div>\n\n                </button>\n\n            </ion-col>\n\n\n\n            <ion-col col-6 no-padding>\n\n                <button ion-button full large color="blue" no-margin (tap)="btnAllJobs()">\n\n                    <div>\n\n                        <ion-icon name="list"></ion-icon>\n\n                        {{\'BUTTON.All Jobs\' | translate}}\n\n                    </div>\n\n                </button>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-footer>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\home\home.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_3__providers_user_auth__["a" /* AuthProvider */],
            __WEBPACK_IMPORTED_MODULE_4__providers_diagnostic_diagnostic__["a" /* DiagnosticProvider */],
            __WEBPACK_IMPORTED_MODULE_5__providers_user_user_driver__["a" /* UserDriverProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
