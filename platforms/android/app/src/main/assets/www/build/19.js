...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CurrentJobPageModule", function() { return CurrentJobPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__current_job__ = __webpack_require__(1130);
...
var CurrentJobPageModule = /** @class */ (function () {
    function CurrentJobPageModule() {
    }
    CurrentJobPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__current_job__["a" /* CurrentJobPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__current_job__["a" /* CurrentJobPage */]),
            ],
        })
    ], CurrentJobPageModule);
    return CurrentJobPageModule;
}());

//# sourceMappingURL=current-job.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CurrentJobPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_launch_navigator__ = __webpack_require__(857);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_current_job_current_job__ = __webpack_require__(854);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_classes_job__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_notification_notification__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_user_user_driver__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_navigation_navigation__ = __webpack_require__(542);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
var CurrentJobPage = /** @class */ (function (_super) {
    __extends(CurrentJobPage, _super);
    function CurrentJobPage(currentJob, driver, launchNavigator, navCtrl, navParams, notify) {
        var _this = _super.call(this, { navCtrl: navCtrl }) || this;
        ...
        _this.notify = notify;
        _this.enableMail = __WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].features.showJobsMail; // hide button if feature is not enabled
        _this.disableBtnDo = false;
        return _this;
    }
    CurrentJobPage.prototype.ionViewCanEnter = function () {
        var _this = this;
        this.job = this.navParams.get('job');
        if (!(this.job instanceof __WEBPACK_IMPORTED_MODULE_6__providers_classes_job__["b" /* Job */])) {
    ...
    CurrentJobPage.prototype.btnCustomerService = function () {
        this.goPage('CustomerServicePage', { jobs: [this.job] });
    };
    CurrentJobPage.prototype.btnNavigate = function () {
        var _this = this;
        ...
        this.launchNavigator.availableApps()
            .catch(function () { return undefined; }) // always resolve
            .then(function (availableApps) {
            var atLeastOneAvailable = Object(__WEBPACK_IMPORTED_MODULE_3_lodash_es__["i" /* some */])(availableApps, function (app) { return app; });
            if (!atLeastOneAvailable) {
                _this.notify.error('There is no navigation app available on this phone.');
            }
            _this.launchNavigator.navigate([_this.job.Lat, _this.job.Lng]);
        });
    };
    CurrentJobPage.prototype.btnSuccess = function () {
        if (this.allowAttempt() === true) {
            this.currentJob.setSuccess(this.job.Id);
            this.goPage('ItemsHandledPage');
        }
    };
    CurrentJobPage.prototype.btnFail = function () {
        if (this.allowAttempt() === true) {
            this.currentJob.setFail(this.job.Id);
            this.goPage('AddNotePage');
        }
    };
    CurrentJobPage.prototype.allowAttempt = function () {
    ...
    CurrentJobPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-current-job',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\current-job\current-job.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <vrp-header>{{\'PAGE.CURRENT_JOB.Header\' | translate}}</vrp-header>\n\n\n\n        <ion-buttons end *ngIf="enableMail">\n\n            <button ion-button (tap)="btnCustomerService()" color="secondary">\n\n                <ion-icon large name="mail"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <vrp-job-details [job]="job" showItems="true"></vrp-job-details>\n\n</ion-content>\n\n\n\n<ion-footer>\n\n    <ion-grid no-padding>\n\n        <ion-row>\n\n            <ion-col col-6 no-padding>\n\n                <a button ion-button full large color="navy" no-margin href="tel:{{this.job.ContactPhone}}">\n\n                    <div>\n\n                        <ion-icon name="call"></ion-icon>\n\n                        {{\'PAGE.CURRENT_JOB.BtnCall\' | translate}}\n\n                    </div>\n\n                </a>\n\n            </ion-col>\n\n\n\n            <ion-col col-6 no-padding>\n\n                <button ion-button full large color="blue" no-margin (tap)="btnNavigate()">\n\n                    <div>\n\n                        <ion-icon name="navigate"></ion-icon>\n\n                        {{\'PAGE.CURRENT_JOB.BtnNavigate\' | translate}}\n\n                    </div>\n\n                </button>\n\n            </ion-col>\n\n        </ion-row>\n\n\n\n        <ion-row>\n\n            <ion-col col-6 no-padding>\n\n                <button ion-button full large [color]="disableBtnDo ? \'grey\' : \'orange\'" no-margin (tap)="btnFail()">\n\n                    <div>\n\n                        <ion-icon name="close-circle"></ion-icon>\n\n                        {{\'PAGE.CURRENT_JOB.BtnFail\' | translate}}\n\n                    </div>\n\n                </button>\n\n            </ion-col>\n\n\n\n            <ion-col col-6 no-padding>\n\n                <button ion-button full large [color]="disableBtnDo ? \'grey\' : \'green\'" no-margin (tap)="btnSuccess()">\n\n                    <div>\n\n                        <ion-icon name="checkmark-circle"></ion-icon>\n\n                        {{\'PAGE.CURRENT_JOB.BtnSuccess\' | translate}}\n\n                    </div>\n\n                </button>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-footer>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\current-job\current-job.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__providers_current_job_current_job__["a" /* CurrentJobProvider */],
            __WEBPACK_IMPORTED_MODULE_8__providers_user_user_driver__["a" /* UserDriverProvider */],
...
}(__WEBPACK_IMPORTED_MODULE_9__providers_navigation_navigation__["a" /* NavigationProvider */]));
