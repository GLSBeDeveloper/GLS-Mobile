...
export class UserDriverProvider {
     ...
     */
    initDriver(userDetails: AuthResponse): Promise<void> {
        ...
        return this.getJobsFromServer().then(() => {
            return this.uploadOfflineJobs().catch(() => { });
        });
    }
     ...
     */
    private overwriteGlobals(serverSettings: AuthResponse): void {
