...
export class Globals {
    ...
    static readonly login = {
        ...
        image: {
            ...
            height: '70px', // specify unit (e.g. px) as well
        },
    };
    static readonly home = {
        page: 'HomePage',
        title: 'SIMTech MCT <sup>TM</sup>', // html tags allowed
    };
    static readonly features = {
         ...
         */
        showEula: false,
        showChangeUrl: true, // allow server url to be modified by drivers. if false, defaultUrl must be specified
        ...
        showJobsReorderBtn: true, // allow driver to reorder jobs in all jobs page
        /**
         * Major features
         */
        enableSSLPinning: false, // if true, showChangeUrl MUST be false
