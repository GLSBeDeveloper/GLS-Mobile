...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__settings__ = __webpack_require__(1152);
...
var SettingPageModule = /** @class */ (function () {
    ...
    SettingPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__settings__["a" /* SettingPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__settings__["a" /* SettingPage */]),
            ],
        })
    ], SettingPageModule);
...
var SettingPage = /** @class */ (function () {
    function SettingPage(navCtrl) {
        ...
        this.tabs = [];
        if (__WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].features.showChangeDriverInfo === true) { // hide page if feature is not enabled
            this.tabs.push({ page: 'ChangeDriverDetailsPage', title: 'Plate Number', icon: 'car' });
        }
        if (__WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].features.enableOfflineSync === true) { // hide page if feature is not enabled
            this.tabs.push({ page: 'OfflineSyncPage', title: 'Sync Jobs', icon: 'archive' });
        }
        if (__WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].features.showChangePassword === true) { // hide page if feature is not enabled
    ...
    SettingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-settings',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\settings\settings.html"*/'<ion-header no-border>\n\n    <ion-navbar>\n\n        <vrp-header>{{\'PAGE.SETTINGS.Header\' | translate}}</vrp-header>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    <ion-tabs>\n\n        <ion-tab *ngFor="let tab of tabs" [root]="tab.page" [tabTitle]="tab.title" [tabIcon]="tab.icon"></ion-tab>\n\n    </ion-tabs>\n\n</ion-content>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\settings\settings.html"*/,
        }),
