...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__summary__ = __webpack_require__(1138);
    ...
    SummaryPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__summary__["a" /* SummaryPage */]),
            ],
        })
    ], SummaryPageModule);
...
var SummaryPage = /** @class */ (function (_super) {
    ...
    function SummaryPage(alertCtrl, currentJob, driver, loading, platform, navCtrl, notify) {
        var _this = _super.call(this, { navCtrl: navCtrl }) || this;
        _this.alertCtrl = alertCtrl;
    ...
    SummaryPage.prototype.ionViewCanEnter = function () {
        var _this = this;
    ...
    SummaryPage.prototype.btnDone = function () {
        var _this = this;
        var jobExists = Object(__WEBPACK_IMPORTED_MODULE_2_lodash_es__["b" /* find */])(this.driver.jobs, { Id: this.currentJob.id });
        if (!jobExists) {
            this.notify.error('This job has been deleted from your job list!');
            this.goPage('AllJobsPage');
            return;
        }
        var loader = this.loading.show('Updating server. This may take some time, please wait');
        if (this.platform.is('ios')) {
            loader.dismiss();
        }
        this.currentJob.complete().then(function () {
            if (_this.platform.is('android')) {
                loader.dismiss();
            }
            _this.notify.info('Job has been done successfully');
            _this.goHomePage();
        }).catch(function (err) {
            loader.dismiss();
            ...
            if (err === 'invalid_items') {
                var alert_1 = _this.alertCtrl.create({
                    ...
                    buttons: [{
                            text: 'OK',
                            handler: function () {
                                _this.goPreviousPage(4); // go to items page
                            },
                        }],
                });
                alert_1.present();
