...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppPermissionPageModule", function() { return AppPermissionPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_permission__ = __webpack_require__(1127);
...
var AppPermissionPageModule = /** @class */ (function () {
    function AppPermissionPageModule() {
    }
    AppPermissionPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__app_permission__["a" /* AppPermissionPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__app_permission__["a" /* AppPermissionPage */]),
            ],
        })
    ], AppPermissionPageModule);
    return AppPermissionPageModule;
}());

//# sourceMappingURL=app-permission.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AppPermissionPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_distinctUntilChanged__ = __webpack_require__(856);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_geolocation_geolocation__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_diagnostic_diagnostic__ = __webpack_require__(545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_navigation_navigation__ = __webpack_require__(542);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_notification_notification__ = __webpack_require__(111);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
var AppPermissionPage = /** @class */ (function (_super) {
    __extends(AppPermissionPage, _super);
    function AppPermissionPage(auth, diagnostic, geolocation, notify, platform, viewCtrl) {
         ...
         * @private
         */
        _this.systemSpecs = (_a = {},
            _a[__WEBPACK_IMPORTED_MODULE_6__providers_diagnostic_diagnostic__["b" /* OperatingSystem */].Android] = { recommend: 6, text: 'Android' },
            _a[__WEBPACK_IMPORTED_MODULE_6__providers_diagnostic_diagnostic__["b" /* OperatingSystem */].iOS] = { recommend: 8, text: 'iOS' },
            _a);
    ...
    AppPermissionPage.prototype.ionViewCanEnter = function () {
        var _this = this;
        ...
        return Promise.all([
            ...
            _this.permission.camera = permission[0];
            _this.permission.location = permission[1];
        });
    };
    AppPermissionPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.btnBackEvent = this.overwriteBackBtnEvent();
        this.notifierEvent = this.diagnostic.hasLocationNotifier.distinctUntilChanged().subscribe(function (enabled) { return _this.permission.location = enabled; });
        this.specs = this.systemSpecs[this.diagnostic.deviceOS];
    };
    AppPermissionPage.prototype.ionViewDidLeave = function () {
        this.btnBackEvent();
        this.notifierEvent.unsubscribe();
    };
    AppPermissionPage.prototype.btnEnableLocation = function () {
        this.diagnostic.requestLocation();
    };
    AppPermissionPage.prototype.btnEnableCamera = function () {
        this.diagnostic.requestCamera();
    };
    AppPermissionPage.prototype.btnContinue = function () {
        if (this.hasRequiredPermissions() === true) {
            this.geolocation.start(__WEBPACK_IMPORTED_MODULE_3__globals__["a" /* Globals */].user.vehicleId, __WEBPACK_IMPORTED_MODULE_3__globals__["a" /* Globals */].user.vehiclePlateNumber, __WEBPACK_IMPORTED_MODULE_3__globals__["a" /* Globals */].user.vehicleUserGroup);
    ...
    AppPermissionPage.prototype.hasRequiredPermissions = function () {
        // boolean check can be extended easily if new permissions are required
        return this.permission.location;
    };
    AppPermissionPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-app-permission',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\app-permission\app-permission.html"*/'<ion-content>\n\n    <ion-list no-lines>\n\n        <ion-item-group text-center>\n\n            <h1>\n\n                <ion-icon large name="megaphone"></ion-icon>\n\n                <br> {{\'PAGE.PERMISSION.Header\' | translate}}\n\n            </h1>\n\n        </ion-item-group>\n\n\n\n        <ion-item-group>\n\n            <ion-item text-wrap>\n\n                {{\'PAGE.PERMISSION.PageReason\' | translate}}.\n\n                <span ion-text color="danger">{{\'PAGE.PERMISSION.ClickAllow\' | translate}}.</span>\n\n            </ion-item>\n\n        </ion-item-group>\n\n\n\n        <ion-item-group>\n\n            <button ion-item text-wrap (tap)="btnEnableLocation()">\n\n                <ion-icon name="pin" item-start></ion-icon>\n\n                <strong>{{\'PAGE.PERMISSION.Location\' | translate}}</strong>\n\n                <ion-badge color="primary">{{\'Required\' | translate}}</ion-badge>\n\n                <br> {{\'PAGE.PERMISSION.LocationReason\' | translate}}.\n\n                <ion-icon item-end name="checkmark-circle" *ngIf="permission.location"></ion-icon>\n\n                <ion-icon item-end name="close-circle" *ngIf="!permission.location"></ion-icon>\n\n            </button>\n\n        </ion-item-group>\n\n\n\n        <ion-item-group>\n\n            <button ion-item text-wrap (tap)="btnEnableCamera()">\n\n                <ion-icon name="camera" item-start></ion-icon>\n\n                <strong>{{\'PAGE.PERMISSION.Camera\' | translate}}</strong>\n\n                <ion-badge color="secondary">{{\'Optional\' | translate}}</ion-badge>\n\n                <br> {{\'PAGE.PERMISSION.CameraReason\' | translate}}.\n\n                <ion-icon item-end name="checkmark-circle" *ngIf="permission.camera"></ion-icon>\n\n                <ion-icon item-end name="close-circle" *ngIf="!permission.camera"></ion-icon>\n\n            </button>\n\n        </ion-item-group>\n\n\n\n        <ion-item-group *ngIf="specs">\n\n            <ion-item text-wrap>\n\n                <strong>{{\'Note\' | translate}}:</strong> {{\'PAGE.PERMISSION.Suggestion\' | translate: ({ os: specs.text, version:\n\n                diagnostic.deviceVersion, recommend: specs.recommend })}}.\n\n            </ion-item>\n\n        </ion-item-group>\n\n    </ion-list>\n\n</ion-content>\n\n\n\n<ion-footer>\n\n    <ion-grid no-padding>\n\n        <ion-row>\n\n            <ion-col col-12 no-padding>\n\n                <button ion-button full large color="primary" no-margin (tap)="btnContinue()">\n\n                    {{\'BUTTON.Continue\' | translate}}\n\n                </button>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-footer>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\app-permission\app-permission.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__providers_user_auth__["a" /* AuthProvider */],
            __WEBPACK_IMPORTED_MODULE_6__providers_diagnostic_diagnostic__["a" /* DiagnosticProvider */],
            __WEBPACK_IMPORTED_MODULE_5__providers_geolocation_geolocation__["a" /* GeolocationProvider */],
