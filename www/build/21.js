...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CompleteJobDetailsPageModule", function() { return CompleteJobDetailsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__complete_job_details__ = __webpack_require__(1128);
...
var CompleteJobDetailsPageModule = /** @class */ (function () {
    function CompleteJobDetailsPageModule() {
    }
    CompleteJobDetailsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__complete_job_details__["a" /* CompleteJobDetailsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__complete_job_details__["a" /* CompleteJobDetailsPage */]),
            ],
        })
    ], CompleteJobDetailsPageModule);
    return CompleteJobDetailsPageModule;
}());

//# sourceMappingURL=complete-job-details.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CompleteJobDetailsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__globals__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_classes_job__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_driver_rest_driver_rest__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_notification_notification__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_navigation_navigation__ = __webpack_require__(542);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
var CompleteJobDetailsPage = /** @class */ (function (_super) {
    __extends(CompleteJobDetailsPage, _super);
    function CompleteJobDetailsPage(jobsApi, navCtrl, navParams, notify) {
        var _this = _super.call(this, { navCtrl: navCtrl }) || this;
        _this.jobsApi = jobsApi;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.notify = notify;
        _this.jobAttemptedBefore = false;
        _this.disableBtnNotePhotos = false;
        _this.disableBtnPod = false;
        return _this;
    }
    CompleteJobDetailsPage.prototype.ionViewCanEnter = function () {
        var _this = this;
        this.job = this.navParams.get('job');
        if (!(this.job instanceof __WEBPACK_IMPORTED_MODULE_3__providers_classes_job__["b" /* Job */])) {
            setTimeout(function () { return _this.goHomePage(); });
            return false;
        }
        this.jobAttemptedBefore = (this.job.isCompleted() || this.job.isUnsuccessful());
        var dictionary = __WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].jobStatusPair[this.job.Status];
        this.statusText = dictionary.title;
        this.statusColor = dictionary.color;
    };
    CompleteJobDetailsPage.prototype.btnShowNotePhotos = function () {
        var _this = this;
        ...
        this.jobsApi.getNotePhotos(this.job.Id)
            ...
            if (photos === undefined || photos.length === 0) {
                ...
                _this.notePhotos = photos.map(_this.base64ToDataUrl);
            }
        })
            .catch(function (err) { return _this.notify.error('Unable to download note photos.', err); });
    };
    CompleteJobDetailsPage.prototype.btnShowPod = function () {
        var _this = this;
        ...
        this.jobsApi.getPodPhotos(this.job.Id)
            ...
            if (photos) {
                _this.podPhotos = [
                    _this.base64ToDataUrl(photos.Signature),
                    _this.base64ToDataUrl(photos.Photo),
                ];
            }
            else {
                _this.podPhotos = [];
            ...
            .catch(function (err) { return _this.notify.error('Unable to download proof of delivery.', err); });
    };
    CompleteJobDetailsPage.prototype.base64ToDataUrl = function (base64) {
        return base64 ? 'data:image/png;base64,' + base64 : undefined;
    };
    CompleteJobDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-complete-job-details',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\complete-job-details\complete-job-details.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <vrp-header>{{\'PAGE.COMPLETE_JOB_SUMMARY.Header\' | translate}}</vrp-header>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <vrp-job-details [job]="job" showItems="true"></vrp-job-details>\n\n\n\n    <ion-list *ngIf="jobAttemptedBefore">\n\n        <ion-item-group>\n\n            <ion-list-header color="dark">\n\n                <ion-icon name="clipboard" item-start></ion-icon>\n\n                {{\'JOB.Status\' | translate}}\n\n            </ion-list-header>\n\n            <ion-item text-wrap>\n\n                <div ion-text [color]="statusColor" [innerText]="statusText"></div>\n\n            </ion-item>\n\n        </ion-item-group>\n\n\n\n        <ion-item-group>\n\n            <ion-list-header color="dark">\n\n                <ion-icon name="paper" item-start></ion-icon>\n\n                {{\'JOB.NoteFromDriver\' | translate}}\n\n\n\n            </ion-list-header>\n\n            <ion-item text-wrap>\n\n                <vrp-jobnote-label [notes]="job.NoteFromDriver"></vrp-jobnote-label>\n\n            </ion-item>\n\n        </ion-item-group>\n\n\n\n        <ion-item-group>\n\n            <ion-list-header color="dark">\n\n                <ion-icon name="photos" item-start></ion-icon>\n\n                {{\'JOB.NotePhotos\' | translate}}\n\n            </ion-list-header>\n\n            <ion-item text-wrap text-center *ngIf="!notePhotos">\n\n                <button class="viewBtns" ion-button full round color="secondary" [disabled]="disableBtnNotePhotos" (tap)="btnShowNotePhotos()">\n\n                    <ion-icon name="cloud-download"></ion-icon>\n\n                    {{\'BUTTON.Tap here to view\' | translate}}\n\n                </button>\n\n            </ion-item>\n\n            <ion-item *ngIf="notePhotos">\n\n                <span *ngIf="!notePhotos.length">({{\'None\' | translate}})</span>\n\n                <vrp-photos [photos]="notePhotos"></vrp-photos>\n\n            </ion-item>\n\n        </ion-item-group>\n\n\n\n        <ion-item-group>\n\n            <ion-list-header color="dark">\n\n                <ion-icon name="create" item-start></ion-icon>\n\n                 {{\'JOB.POD\' | translate}}\n\n            </ion-list-header>\n\n            <ion-item text-wrap text-center *ngIf="!podPhotos">\n\n                <button class="viewBtns" ion-button full round color="secondary" [disabled]="disableBtnPod" (tap)="btnShowPod()">\n\n                    <ion-icon name="cloud-download"></ion-icon>\n\n                    {{\'BUTTON.Tap here to view\' | translate}}\n\n                </button>\n\n            </ion-item>\n\n            <ion-item *ngIf="podPhotos">\n\n                <span *ngIf="!podPhotos.length">({{\'None\' | translate}})</span>\n\n                <vrp-photos [photos]="podPhotos"></vrp-photos>\n\n            </ion-item>\n\n        </ion-item-group>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\complete-job-details\complete-job-details.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__providers_driver_rest_driver_rest__["c" /* JobsApi */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
