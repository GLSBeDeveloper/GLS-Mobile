...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__customer_service__ = __webpack_require__(1139);
...
var CustomerServicePageModule = /** @class */ (function () {
    ...
    CustomerServicePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__customer_service__["a" /* CustomerServicePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__customer_service__["a" /* CustomerServicePage */]),
            ],
        })
...
//# sourceMappingURL=customer-service.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_loading_loading__ = __webpack_require__(543);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_notification_notification__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_driver_rest_driver_rest__ = __webpack_require__(112);
/**
 * @license
 * Copyright Singapore Institute of Manufacturing Technology (SIMTech). All Rights Reserved.
 *
...
var CustomerServicePage = /** @class */ (function () {
    function CustomerServicePage(loading, mailApi, navParams, notify, viewCtrl) {
        this.loading = loading;
        this.mailApi = mailApi;
        this.navParams = navParams;
        this.notify = notify;
        this.viewCtrl = viewCtrl;
        this.errorMsg = 'Unable to send message. Please contact customer service directly.';
        this.timeList = [
            '30 Minutes',
            '60 Minutes',
        ];
    }
    CustomerServicePage.prototype.ionViewCanEnter = function () {
        this.jobs = this.navParams.get('jobs');
        if (this.jobs === undefined || !this.jobs.length || !(this.jobs[0] instanceof __WEBPACK_IMPORTED_MODULE_2__providers_classes_job__["b" /* Job */])) { // assumes that the entire array consist of same object types
            this.viewCtrl.dismiss();
            this.notify.error(this.errorMsg);
            return false;
        }
    };
    CustomerServicePage.prototype.btnSelectTime = function (time) {
        this.selectedTime = time;
    };
    CustomerServicePage.prototype.btnSubmit = function () {
        var _this = this;
        if (this.isValid() === true) {
            var loader_1 = this.loading.show();
            var message = {
                jobs: this.jobs.map(function (job) { return job.toJSON(); }),
                lateBy: this.selectedTime,
                driverRemarks: this.remarks,
            };
            this.mailApi.send(message).then(function () {
                loader_1.dismiss();
                _this.btnClear();
                _this.viewCtrl.dismiss();
                _this.notify.info('Message sent successfully.');
            }).catch(function (err) {
                loader_1.dismiss();
                _this.notify.error(_this.errorMsg, err);
            });
        }
    };
    CustomerServicePage.prototype.btnClear = function () {
        this.selectedTime = undefined;
        this.remarks = '';
    };
    CustomerServicePage.prototype.isValid = function () {
        this.remarks = Object(__WEBPACK_IMPORTED_MODULE_3_lodash_es__["l" /* trim */])(this.remarks);
        var errors = [];
    ...
    CustomerServicePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-customer-service',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\customer-service\customer-service.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <vrp-header>{{\'PAGE.CUSTOMER_SERVICE.Header\' | translate}}</vrp-header>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-list>\n\n        <ion-list-header color="dark">\n\n            {{\'PAGE.CUSTOMER_SERVICE.ExpectLateHeader\' | translate}}\n\n        </ion-list-header>\n\n\n\n        <ion-item-group radio-group [(ngModel)]="selectedTime">\n\n            <ion-item *ngFor="let time of timeList">\n\n                <ion-label [innerText]="time"></ion-label>\n\n                <ion-radio [value]="time"></ion-radio>\n\n            </ion-item>\n\n        </ion-item-group>\n\n\n\n        <ion-list-header color="dark">\n\n            {{\'PAGE.CUSTOMER_SERVICE.RemarksHeader\' | translate}}\n\n        </ion-list-header>\n\n\n\n        <ion-item-group>\n\n            <ion-item>\n\n                <ion-textarea rows="3" (keydown.enter)="false" [(ngModel)]="remarks"></ion-textarea>\n\n            </ion-item>\n\n        </ion-item-group>\n\n\n\n        <ion-list-header color="dark">\n\n            {{\'PAGE.CUSTOMER_SERVICE.SelectedJobsHeader\' | translate}}\n\n        </ion-list-header>\n\n\n\n        <ion-item-group>\n\n            <ion-item *ngFor="let job of jobs" text-wrap>\n\n                #{{job.DeliveryMasterId}}\n\n                <br> <vrp-jobtype-label [jobtype]="job.JobType"></vrp-jobtype-label>\n\n                <br> {{job.StartTimeWindow | date:\'shortTime\'}} to {{job.EndTimeWindow | date:\'shortTime\'}}\n\n            </ion-item>\n\n        </ion-item-group>\n\n    </ion-list>\n\n</ion-content>\n\n\n\n<ion-footer class="hide-on-keyboard-open">\n\n    <ion-grid no-padding>\n\n        <ion-row>\n\n            <ion-col col-6 no-padding>\n\n                <vrp-btn-clear (pressed)="btnClear()"></vrp-btn-clear>\n\n            </ion-col>\n\n\n\n            <ion-col col-6 no-padding>\n\n                <button ion-button full large color="secondary" no-margin (tap)="btnSubmit()">\n\n                    <div>\n\n                        <ion-icon name="send"></ion-icon>\n\n                        {{\'BUTTON.Submit\' | translate}}\n\n                    </div>\n\n                </button>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-footer>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\customer-service\customer-service.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__providers_loading_loading__["a" /* LoadingProvider */],
            __WEBPACK_IMPORTED_MODULE_6__providers_driver_rest_driver_rest__["d" /* MailApi */],
