...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PlannerNotesPageModule", function() { return PlannerNotesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__planner_notes__ = __webpack_require__(1126);
...
var PlannerNotesPageModule = /** @class */ (function () {
    function PlannerNotesPageModule() {
    }
    PlannerNotesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__planner_notes__["a" /* PlannerNotesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__planner_notes__["a" /* PlannerNotesPage */]),
            ],
        })
    ], PlannerNotesPageModule);
    return PlannerNotesPageModule;
}());

//# sourceMappingURL=planner-notes.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PlannerNotesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__globals__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_user_driver__ = __webpack_require__(137);
...
var PlannerNotesPage = /** @class */ (function (_super) {
    __extends(PlannerNotesPage, _super);
    function PlannerNotesPage(driver, menuCtrl, navCtrl) {
        var _this = _super.call(this, { navCtrl: navCtrl }) || this;
        _this.driver = driver;
    ...
    PlannerNotesPage.prototype.ionViewWillEnter = function () {
        if (__WEBPACK_IMPORTED_MODULE_2__globals__["a" /* Globals */].features.showAllJobsMenu === true) {
            this.menuCtrl.enable(true, __WEBPACK_IMPORTED_MODULE_2__globals__["c" /* MenuName */].AllJobs);
        }
    };
    PlannerNotesPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.navBar.backButtonClick = function () { return _this.goHomePage(); };
    };
    PlannerNotesPage.prototype.ionViewWillLeave = function () {
        this.menuCtrl.enable(false, __WEBPACK_IMPORTED_MODULE_2__globals__["c" /* MenuName */].AllJobs);
    };
    __decorate([
    ...
    ], PlannerNotesPage.prototype, "navBar", void 0);
    PlannerNotesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-planner-notes',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\all-jobs\planner-notes\planner-notes.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <vrp-header>{{\'PAGE.PLANNER_NOTES.Header\' | translate}}</vrp-header>\n\n\n\n        <button end ion-button menuToggle="right">\n\n            <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-list>\n\n        <ion-item-group *ngFor="let job of driver.jobs">\n\n            <ng-container *ngIf="job.NoteFromPlanner.length">\n\n                <ion-item-divider sticky>\n\n                    <ion-label item-start>\n\n                        <strong>#{{job.DeliveryMasterId}}</strong>\n\n                    </ion-label>\n\n                    <vrp-jobtype-label [jobtype]="job.JobType" item-end></vrp-jobtype-label>\n\n                </ion-item-divider>\n\n\n\n                <ion-item text-wrap>\n\n                    <vrp-jobnote-label [notes]="job.NoteFromPlanner"></vrp-jobnote-label>\n\n                </ion-item>\n\n            </ng-container>\n\n        </ion-item-group>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\all-jobs\planner-notes\planner-notes.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__providers_user_user_driver__["a" /* UserDriverProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* MenuController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */]])
    ], PlannerNotesPage);
    return PlannerNotesPage;
}(__WEBPACK_IMPORTED_MODULE_4__providers_navigation_navigation__["a" /* NavigationProvider */]));

//# sourceMappingURL=planner-notes.js.map
