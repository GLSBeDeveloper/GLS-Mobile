...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PodPageModule", function() { return PodPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pod__ = __webpack_require__(1136);
...
var PodPageModule = /** @class */ (function () {
    function PodPageModule() {
    }
    PodPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__pod__["a" /* PodPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__pod__["a" /* PodPage */]),
            ],
        })
    ], PodPageModule);
    return PodPageModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PodPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_classes_job__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_current_job_current_job__ = __webpack_require__(854);
...
(function (TabPageName) {
    TabPageName["Code"] = "VerifyCodePage";
    TabPageName["Signature"] = "PodSignaturePage";
    TabPageName["Photo"] = "PodPhotoPage";
})(TabPageName || (TabPageName = {}));
var CustomTab = /** @class */ (function () {
    function CustomTab(init) {
        this.show = true;
        this.visited = false;
        this.enabled = false;
...
var PodPage = /** @class */ (function (_super) {
    __extends(PodPage, _super);
    function PodPage(currentJob, navCtrl, notify) {
        var _this = _super.call(this, { navCtrl: navCtrl }) || this;
        ...
        if (__WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].features.showPodPhotoTab === true) {
            _this.tabs.push(new CustomTab({ page: TabPageName.Photo, title: 'Photo', icon: 'camera' }));
        }
        return _this;
    }
    PodPage.prototype.ionViewCanEnter = function () {
        var _this = this;
        this.job = this.currentJob.getDetails();
        if (!(this.job instanceof __WEBPACK_IMPORTED_MODULE_2__providers_classes_job__["b" /* Job */])) {
    ...
    PodPage.prototype.tabSelected = function (tab) {
        this.tabs[tab.index].visited = true;
    };
    PodPage.prototype.enablePodTabs = function () {
        this.enableTab(TabPageName.Signature);
        this.enableTab(TabPageName.Photo);
    };
    PodPage.prototype.removeTab = function (tabPage) {
        var tabToBeRemoved = this.tabs.find(function (tab) { return tab.page === tabPage; });
        if (tabToBeRemoved) {
            tabToBeRemoved.show = false;
            tabToBeRemoved.enabled = false;
        }
    };
    PodPage.prototype.enableTab = function (tabPage) {
        var tabToBeEnabled = this.tabs.find(function (tab) { return tab.page === tabPage; });
        if (tabToBeEnabled) {
    ...
    PodPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-pod',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\current-job\pod\pod.html"*/'<ion-header no-border>\n\n    <ion-navbar>\n\n        <vrp-header showDialog="true">{{\'JOB.POD\' | translate}}</vrp-header>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    <ion-tabs (ionChange)="tabSelected($event)">\n\n        <ion-tab *ngFor="let tab of tabs" [root]="tab.page" tabBadgeStyle="light" [tabBadge]="!tab.visited ? \'*\' : \'\'" [tabTitle]="tab.title"\n\n            [tabIcon]="tab.icon" [enabled]="tab.enabled" [show]="tab.show"></ion-tab>\n\n    </ion-tabs>\n\n</ion-content>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\current-job\pod\pod.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__providers_current_job_current_job__["a" /* CurrentJobProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
