...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NextDayJobsPageModule", function() { return NextDayJobsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__next_day_jobs__ = __webpack_require__(1125);
...
var NextDayJobsPageModule = /** @class */ (function () {
    function NextDayJobsPageModule() {
    }
    NextDayJobsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__next_day_jobs__["a" /* NextDayJobsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__next_day_jobs__["a" /* NextDayJobsPage */]),
            ],
        })
    ], NextDayJobsPageModule);
    return NextDayJobsPageModule;
}());

//# sourceMappingURL=next-day-jobs.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NextDayJobsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
...
var NextDayJobsPage = /** @class */ (function (_super) {
    __extends(NextDayJobsPage, _super);
    function NextDayJobsPage(jobsApi, menuCtrl, notify, navCtrl) {
        var _this = _super.call(this, { navCtrl: navCtrl }) || this;
    ...
    NextDayJobsPage.prototype.ionViewWillEnter = function () {
    ...
    NextDayJobsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.navBar.backButtonClick = function () { return _this.goHomePage(); };
    };
    NextDayJobsPage.prototype.ionViewWillLeave = function () {
        this.menuCtrl.enable(false, __WEBPACK_IMPORTED_MODULE_3__globals__["c" /* MenuName */].AllJobs);
    };
    NextDayJobsPage.prototype.ionViewCanEnter = function () {
        var _this = this;
        // TODO: allow server to determine when is the next day
        var nextDay = __WEBPACK_IMPORTED_MODULE_2_moment__().add(1, 'day');
        ...
        return this.jobsApi.get({ date: nextDay.toISOString() })
            ...
            .catch(function (err) {
            _this.notify.error('Unable to get next day\'s jobs.', err);
            throw err;
        });
    };
    __decorate([
    ...
    ], NextDayJobsPage.prototype, "navBar", void 0);
    NextDayJobsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-next-day-jobs',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\all-jobs\next-day-jobs\next-day-jobs.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <vrp-header>{{\'PAGE.NEXT_DAY.Header\' | translate}}</vrp-header>\n\n\n\n        <button end ion-button menuToggle="right">\n\n            <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-list>\n\n        <ion-list-header color="dark">\n\n            {{\'Date\' | translate}}: {{date}}\n\n        </ion-list-header>\n\n\n\n        <ion-card full *ngIf="!jobs.length">\n\n            <ion-card-header text-wrap color="secondary">\n\n                <ion-icon item-start name="thumbs-up"></ion-icon>\n\n                {{\'Ok\' | translate}}\n\n            </ion-card-header>\n\n\n\n            <ion-card-content>\n\n                {{\'PAGE.NEXT_DAY.NoJobs\' | translate}}.\n\n            </ion-card-content>\n\n        </ion-card>\n\n\n\n        <ion-item *ngFor="let job of jobs">\n\n            <vrp-job-summary [job]="job"></vrp-job-summary>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\all-jobs\next-day-jobs\next-day-jobs.html"*/,
        }),
