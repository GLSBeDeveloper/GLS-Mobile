...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AllJobsPageModule", function() { return AllJobsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__all_jobs__ = __webpack_require__(1124);
...
var AllJobsPageModule = /** @class */ (function () {
    function AllJobsPageModule() {
    }
    AllJobsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__all_jobs__["a" /* AllJobsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__all_jobs__["a" /* AllJobsPage */]),
            ],
        })
    ], AllJobsPageModule);
    return AllJobsPageModule;
}());

//# sourceMappingURL=all-jobs.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AllJobsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_user_user_driver__ = __webpack_require__(137);
...
var AllJobsPage = /** @class */ (function (_super) {
    __extends(AllJobsPage, _super);
    function AllJobsPage(driver, menuCtrl, navCtrl, notify, platform) {
        var _this = _super.call(this, { navCtrl: navCtrl }) || this;
        _this.driver = driver;
        ...
        _this.enableReorder = __WEBPACK_IMPORTED_MODULE_3__globals__["a" /* Globals */].features.showJobsReorderBtn;
        _this.enableMail = __WEBPACK_IMPORTED_MODULE_3__globals__["a" /* Globals */].features.showJobsMail;
        _this.allJobs = []; // list of all jobs for progress bar
        _this.selectedJobs = []; // list of jobs selected to send message to customer service
        _this.canSendMail = false; // indicates whether the selected segment allows mailing
        _this.showCheckboxView = false; // indicates whether to show view to select jobs for customer service
        _this.hasReordered = false; // indicates whether there was a reordering
        _this.canReorder = false; // indicates whether the selected segment allows reordering
        _this.btnReorderVal = false; // value of the reorder button (indicate whether to show view for reordering)
        _this.currList = []; // selected segment's list of jobs (e.g. pending only or fail only etc)
        _this.selectedIndex = 0;
        _this.segments = [
            { title: 'PENDING', statusGroup: [__WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].Pending, __WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].ExpectToBeLate], canReorder: true, canSendMail: true },
            { title: 'FAIL', statusGroup: [__WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].Unsuccessful], canSendMail: true },
            { title: 'DONE', statusGroup: [__WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].Late, __WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].Ontime] },
            { title: 'ALL', statusGroup: [__WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].Pending, __WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].Late, __WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].Ontime, __WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].Unsuccessful, __WEBPACK_IMPORTED_MODULE_4__providers_classes_job__["c" /* JobStatus */].ExpectToBeLate] },
        ];
        _this.platform.ready().then(function () {
            // stop reordering if back button is pressed during reordering
            _this.overwriteBackBtnEvent(function () {
                if (_this.btnReorderVal === true) {
                    _this.btnReorderVal = false;
                }
                else {
    ...
    AllJobsPage.prototype.ionViewWillEnter = function () {
        if (__WEBPACK_IMPORTED_MODULE_3__globals__["a" /* Globals */].features.showAllJobsMenu === true) {
            this.menuCtrl.enable(true, __WEBPACK_IMPORTED_MODULE_3__globals__["c" /* MenuName */].AllJobs);
        }
    };
    AllJobsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.navBar.backButtonClick = function () { return _this.goHomePage(); };
    };
    AllJobsPage.prototype.ionViewDidEnter = function () {
    ...
    AllJobsPage.prototype.ionViewWillLeave = function () {
        ...
        this.menuCtrl.enable(false, __WEBPACK_IMPORTED_MODULE_3__globals__["c" /* MenuName */].AllJobs);
    };
    AllJobsPage.prototype.itemReorder = function (event) {
        this.hasReordered = true;
        var from = this.driver.jobs.indexOf(this.currList[event.from]);
        var to = this.driver.jobs.indexOf(this.currList[event.to]);
        this.swapElem(this.driver.jobs, from, to);
        event.applyTo(this.currList);
    };
    AllJobsPage.prototype.segmentChanged = function (selectedSegment) {
        if (this.driver.jobs.length > 0) {
            var selected_1 = this.segments[selectedSegment.value];
            // update list of jobs to show
            this.currList = this.driver.jobs.filter(function (job) { return selected_1.statusGroup.indexOf(job.Status) > -1; });
            this.canSendMail = selected_1.canSendMail; // determine whether selected segment can have send mail view
            this.showCheckboxView = false; // reset checkbox view (in case it was enabled for previous selected segment)
            this.canReorder = selected_1.canReorder; // determine whether selected segment can have reordering view
    ...
    AllJobsPage.prototype.getColor = function (job) {
        var colorPair = __WEBPACK_IMPORTED_MODULE_3__globals__["a" /* Globals */].jobStatusPair[job.Status];
        return colorPair.color;
    };
    AllJobsPage.prototype.btnChangeView = function () {
        // toggle checkbox view based on whether fab list is opened
        this.showCheckboxView = this.enableMail && this.fab && !this.fab._listsActive;
        // every toggle should clear the list of selected jobs
        this.selectedJobs = [];
    };
    AllJobsPage.prototype.btnSelectedJob = function (selectedJob, event) {
        if (event.checked === true) {
            this.selectedJobs.push(selectedJob);
        }
        else {
            Object(__WEBPACK_IMPORTED_MODULE_2_lodash_es__["h" /* remove */])(this.selectedJobs, function (job) { return job.Id === selectedJob.Id; });
        }
    };
    AllJobsPage.prototype.btnJob = function (job) {
    ...
    AllJobsPage.prototype.btnViewFullDetails = function (job) {
        this.goPage('CompleteJobDetailsPage', { job: job });
    };
    AllJobsPage.prototype.btnSendMail = function () {
    ...
    AllJobsPage.prototype.swapElem = function (arr, fromIndex, toIndex) {
...
//# sourceMappingURL=all-jobs.js.map
