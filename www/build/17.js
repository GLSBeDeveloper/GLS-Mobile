...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PodPhotoPageModule", function() { return PodPhotoPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pod_photo__ = __webpack_require__(1132);
...
var PodPhotoPageModule = /** @class */ (function () {
    function PodPhotoPageModule() {
    }
    PodPhotoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__pod_photo__["a" /* PodPhotoPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__pod_photo__["a" /* PodPhotoPage */]),
            ],
        })
    ], PodPhotoPageModule);
    return PodPhotoPageModule;
}());

//# sourceMappingURL=pod-photo.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PodPhotoPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_camera_camera__ = __webpack_require__(855);
...
var PodPhotoPage = /** @class */ (function (_super) {
    __extends(PodPhotoPage, _super);
    function PodPhotoPage(app, camera, currentJob, notify) {
    ...
    PodPhotoPage.prototype.btnTakePhoto = function () {
        var _this = this;
        this.camera.getPicture()
            .then(function (fileUri) { return _this.currentJob.podPhoto = fileUri; })
            .catch(function () { });
    };
    PodPhotoPage.prototype.btnConfirm = function () {
        if (__WEBPACK_IMPORTED_MODULE_4__globals__["a" /* Globals */].setting.pod.photoRequired === true && this.currentJob.podPhoto === undefined) {
    ...
    PodPhotoPage.prototype.btnClear = function () {
        this.currentJob.podPhoto = undefined;
    };
    PodPhotoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-pod-photo',template:/*ion-inline-start:"G:\GLS\TMS SC\driver-3ebd130\src\pages\current-job\pod\pod-photo\pod-photo.html"*/'<ion-content padding>\n\n    <ion-card full color="dark" *ngIf="!currentJob.podPhoto">\n\n        <ion-card-header>\n\n            <ion-icon item-start name="image"></ion-icon>\n\n            <strong>{{\'PAGE.POD_PHOTO.PhotoOptional\' | translate}}.</strong>\n\n        </ion-card-header>\n\n\n\n        <ion-card-content>\n\n            {{\'PAGE.POD_PHOTO.CentraliseImage\' | translate}}.\n\n        </ion-card-content>\n\n    </ion-card>\n\n\n\n    <ion-item *ngIf="currentJob.podPhoto">\n\n        <vrp-photos [photo]="currentJob.podPhoto"></vrp-photos>\n\n    </ion-item>\n\n\n\n    <ion-fab right bottom>\n\n        <button ion-fab color="orange" (tap)="btnTakePhoto()">\n\n            <ion-icon name="camera"></ion-icon>\n\n        </button>\n\n    </ion-fab>\n\n</ion-content>\n\n\n\n<ion-footer>\n\n    <ion-grid no-padding>\n\n        <ion-row>\n\n            <ion-col col-6 no-padding>\n\n                <vrp-btn-clear (pressed)="btnClear()"></vrp-btn-clear>\n\n            </ion-col>\n\n\n\n            <ion-col col-6 no-padding>\n\n                <button ion-button full large color="secondary" no-margin (tap)="btnConfirm()">\n\n                    <div>\n\n                        <ion-icon name="return-right"></ion-icon>\n\n                        {{\'BUTTON.Proceed\' | translate}}\n\n                    </div>\n\n                </button>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-footer>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\driver-3ebd130\src\pages\current-job\pod\pod-photo\pod-photo.html"*/,
        }),
...
//# sourceMappingURL=pod-photo.js.map
